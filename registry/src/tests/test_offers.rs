...
fn test_offers_start_data(e: &Env, test_data: &TestData) -> (Users, BytesN<32>) {
    ...
    test_data.col_asset_stellar.mock_all_auths().mint(
        &users.initial_user,
        &((test_data.min_duration as i128 * test_data.node_rate as i128) * 2),
    );
...
pub fn test_set_new_buy_offer() {
    ...
    assert_eq!(
        test_data.min_duration as u128 * test_data.node_rate,
        test_data
            .col_asset_client
            .balance(&test_data.contract_client.address) as u128
    );

    let amount: u128 = (test_data.min_duration as u128 * test_data.node_rate) + 100_0000000;
    ...
    assert_eq!(
        (test_data.min_duration as u128 * test_data.node_rate * 2) + 100_0000000,
        test_data
            .col_asset_client
            .balance(&test_data.contract_client.address) as u128
    );
    ...
    e.as_contract(&test_data.contract_client.address, || {
        ...
        if let Offer::BuyOffer(buy_offer) = offer {
            ...
            assert_eq!(buy_offer.snapshot, 0);
    ...
    assert_eq!(
        (test_data.min_duration as u128 * test_data.node_rate) - 100_0000000,
...
pub fn test_update_buy_offer_from_same_buyer() {
    ...
    assert_eq!(
        (test_data.min_duration as u128 * test_data.node_rate * 2) + 110_0000000,
        test_data
            .col_asset_client
            .balance(&test_data.contract_client.address) as u128
    );
    ...
    assert_eq!(
        (test_data.min_duration as u128 * test_data.node_rate) - 110_0000000,
        test_data.col_asset_client.balance(&users.initial_buyer) as u128
    );
}
...
pub fn test_update_buy_offer_from_another_buyer() {
    ...
    assert_eq!(
        test_data.min_duration as u128 * test_data.node_rate * 2,
        test_data.col_asset_client.balance(&users.initial_buyer) as u128
    );
...
pub fn test_set_sale_offer() {
    ...
    e.as_contract(&test_data.contract_client.address, || {
        ...
        if let Offer::SaleOffer(sale_offer) = offer {
            ...
            assert_eq!(sale_offer.snapshot, 0);
...
pub fn test_take_sale_offer() {
    ...
    let profit: u128 = amount - (test_data.node_rate * test_data.min_duration as u128);
    ...
    assert_eq!(
        (test_data.min_duration as u128 * test_data.node_rate * 2) + (100_0000000 - fee),
...
pub fn test_burn_offers() {
    ...
    assert_eq!(
        (test_data.min_duration as i128 * test_data.node_rate as i128) * 2,
        test_data.col_asset_client.balance(&users.initial_buyer)
    );
}
